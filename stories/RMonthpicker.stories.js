                    ...
                    ${formats.map(({format, label, id}) => html`
                        <div>
                            ...
                            <div style="border: 1px solid #ddd; padding: 8px; background: #f8f9fa;">
                                <l-c-range-monthpicker
                                        id="test-range-monthpicker-format-${id}"
                                        label="Month Range"
                                        label-align="top"
                                        size="medium"
                                        width="100%"
            ...
            <div style="flex: 1;">
                ...
                <div style="display: flex; flex-direction: column; gap: 16px;">
                    <div>
                        ...
                        <div style="border: 1px solid #ddd; padding: 8px; background: #f8f9fa;">
                            <l-c-range-monthpicker
                                    id="test-range-monthpicker-popup"
                                    label="Month Range"
                                    label-align="top"
                                    size="medium"
                                    width="100%"
                    ...
                    <div>
                        ...
                        <div style="border: 1px solid #ddd; padding: 8px; background: #f8f9fa;">
                            <l-c-range-monthpicker
                                    id="test-range-monthpicker-inline"
                                    label="Month Range"
                                    label-align="top"
                                    size="medium"
                                    width="100%"
    ...
    return html`
        <div style="display: flex; gap: 2rem; align-items: flex-start;">
            ...
            <div style="flex: 1; border: 1px solid #ddd; padding: 16px; border-radius: 8px;">
                <h3 style="margin: 0 0 1rem 0; color: #333; font-size: 1rem;">Range Monthpicker (DatepickerStyles.js)</h3>
                <l-c-range-monthpicker
                        id="test-range-monthpicker-function"
                ...
                <div style="margin-top: 16px; padding: 12px; background: #f8f9fa; border-radius: 4px;">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 12px;">
                        <button onclick="
                            const monthpicker = document.querySelector('#test-range-monthpicker-function');
                        ...
                        <button onclick="
                            ...
                            document.querySelector('#setFromValue-result').textContent = 'Set from to: 2024-01';
                        ...
                        <button onclick="
                            ...
                            document.querySelector('#setToValue-result').textContent = 'Set to to: 2024-12';
